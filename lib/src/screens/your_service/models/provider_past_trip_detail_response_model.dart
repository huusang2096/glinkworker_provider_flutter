...
class ProviderPastTripDetailResponse {
  ProviderPastTripDetailResponse({
    this.id,
    this.bookingId,
    this.userId,
    this.braintreeNonce,
  ...
  factory ProviderPastTripDetailResponse.fromRawJson(String str) =>
      ProviderPastTripDetailResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory ProviderPastTripDetailResponse.fromJson(Map<String, dynamic> json) =>
      ProviderPastTripDetailResponse(
