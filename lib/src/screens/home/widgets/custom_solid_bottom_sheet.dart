...
class CustomSolidBottomSheet extends StatefulWidget {
  ...
  @override
  _CustomeSolidBottomSheetState createState() =>
      _CustomeSolidBottomSheetState();
}

class _CustomeSolidBottomSheetState extends State<CustomSolidBottomSheet> {
  bool isDragDirectionUp = true;
